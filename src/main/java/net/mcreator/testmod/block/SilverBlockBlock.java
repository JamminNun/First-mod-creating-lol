...
public class SilverBlockBlock extends VariatyAdditionsModElements.ModElement {
	@ObjectHolder("variaty_additions:silver_block")
	public static final Block block = null;
	public SilverBlockBlock(VariatyAdditionsModElements instance) {
		super(instance, 80);
	}
