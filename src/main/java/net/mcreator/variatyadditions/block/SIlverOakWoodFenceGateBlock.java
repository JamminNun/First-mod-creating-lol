...
public class SIlverOakWoodFenceGateBlock extends VariatyAdditionsModElements.ModElement {
	@ObjectHolder("variaty_additions:s_ilver_oak_wood_fence_gate")
	public static final Block block = null;
	public SIlverOakWoodFenceGateBlock(VariatyAdditionsModElements instance) {
		super(instance, 103);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("s_ilver_oak_wood_fence_gate");
		}
