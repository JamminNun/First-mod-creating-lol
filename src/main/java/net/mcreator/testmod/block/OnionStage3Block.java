...
public class OnionStage3Block extends TestmodModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("onion_stage_3"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("testmod:onion_stage_3"), configuredFeature);
		}
	}
	@SubscribeEvent
