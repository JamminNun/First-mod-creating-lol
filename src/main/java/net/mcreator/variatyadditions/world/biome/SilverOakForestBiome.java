...
package net.mcreator.variatyadditions.world.biome;
...
import net.mcreator.variatyadditions.block.SilverOakLogBlock;
import net.mcreator.variatyadditions.block.SilverOakLeavesBlock;
import net.mcreator.variatyadditions.VariatyAdditionsModElements;

@VariatyAdditionsModElements.ModElement.Tag
public class SilverOakForestBiome extends VariatyAdditionsModElements.ModElement {
	public static Biome biome;
	public SilverOakForestBiome(VariatyAdditionsModElements instance) {
		super(instance, 76);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("variaty_additions:silver_oak_forest"));
			}
		}
	}
	@Override
