...
public class MediumBackpackItem extends TestmodModElements.ModElement {
	@ObjectHolder("testmod:medium_backpack")
	public static final Item block = null;
	public MediumBackpackItem(TestmodModElements instance) {
		super(instance, 51);
