...
import net.mcreator.variatyadditions.procedures.OnionStage1ProcedureProcedure;
...
public class OnionStage1Block extends VariatyAdditionsModElements.ModElement {
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("onion_stage_1"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				OnionStage1ProcedureProcedure.executeProcedure($_dependencies);
			}
		}
