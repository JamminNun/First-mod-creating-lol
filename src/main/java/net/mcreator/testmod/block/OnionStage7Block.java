...
public class OnionStage7Block extends TestmodModElements.ModElement {
	@ObjectHolder("testmod:onion_stage_7")
	public static final Block block = null;
	public OnionStage7Block(TestmodModElements instance) {
		super(instance, 27);
	}
