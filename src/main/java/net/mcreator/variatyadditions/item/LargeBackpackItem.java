...
import net.mcreator.variatyadditions.gui.LargeBackpackGUIGuiWindow;
import net.mcreator.variatyadditions.gui.LargeBackpackGUIGui;
...
public class LargeBackpackItem extends VariatyAdditionsModElements.ModElement {
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof LargeBackpackGUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("large_backpack");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Large Backpack");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new LargeBackpackGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
