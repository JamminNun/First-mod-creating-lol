...
public class OnionStage6Block extends TestmodModElements.ModElement {
	@ObjectHolder("testmod:onion_stage_6")
	public static final Block block = null;
	public OnionStage6Block(TestmodModElements instance) {
		super(instance, 26);
	}
