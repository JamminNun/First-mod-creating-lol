...
import net.mcreator.variatyadditions.procedures.SilverOakSaplingUpdateTickProcedure;
import net.mcreator.variatyadditions.procedures.SilverOakSaplingPlantRightClickedProcedure;
...
public class SilverOakSaplingBlock extends VariatyAdditionsModElements.ModElement {
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("silver_oak_sapling");
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				SilverOakSaplingUpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				SilverOakSaplingPlantRightClickedProcedure.executeProcedure($_dependencies);
			}
