...
public class SIlverOakWoodStairsBlock extends VariatyAdditionsModElements.ModElement {
	@ObjectHolder("variaty_additions:s_ilver_oak_wood_stairs")
	public static final Block block = null;
	public SIlverOakWoodStairsBlock(VariatyAdditionsModElements instance) {
		super(instance, 100);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("s_ilver_oak_wood_stairs");
		}
