...
public class SIlverOakWoodPressurePlateBlock extends VariatyAdditionsModElements.ModElement {
	@ObjectHolder("variaty_additions:s_ilver_oak_wood_pressure_plate")
	public static final Block block = null;
	public SIlverOakWoodPressurePlateBlock(VariatyAdditionsModElements instance) {
		super(instance, 104);
	}
	...
	public static class CustomBlock extends PressurePlateBlock {
		public CustomBlock() {
			...
			setRegistryName("s_ilver_oak_wood_pressure_plate");
		}
