...
import net.mcreator.testmod.procedures.OnionStage2ProcedureProcedure;
...
public class OnionStage2Block extends TestmodModElements.ModElement {
	@ObjectHolder("testmod:onion_stage_2")
	public static final Block block = null;
	@ObjectHolder("testmod:onion_stage_2")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public OnionStage2Block(TestmodModElements instance) {
		super(instance, 41);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("onion_stage_2"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("onion_stage_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("testmod:onion_stage_2"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		...
		public ItemStack getPickBlock(BlockState state, RayTraceResult target, IBlockReader world, BlockPos pos, PlayerEntity player) {
			return new ItemStack(OnionSeedItem.block);
		}
		...
		public void tick(BlockState blockstate, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				OnionStage2ProcedureProcedure.executeProcedure($_dependencies);
			}
		}
