...
import net.mcreator.variatyadditions.gui.MediumBackpackGUIGuiWindow;
import net.mcreator.variatyadditions.gui.MediumBackpackGUIGui;
...
public class MediumBackpackItem extends VariatyAdditionsModElements.ModElement {
	@ObjectHolder("variaty_additions:medium_backpack")
	public static final Item block = null;
	public MediumBackpackItem(VariatyAdditionsModElements instance) {
		super(instance, 51);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof MediumBackpackGUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("medium_backpack");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Medium Backpack");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new MediumBackpackGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
