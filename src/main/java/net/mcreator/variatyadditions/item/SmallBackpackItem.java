...
import net.mcreator.variatyadditions.gui.SmallBackpackGUIGuiWindow;
import net.mcreator.variatyadditions.gui.SmallBackpackGUIGui;
...
public class SmallBackpackItem extends VariatyAdditionsModElements.ModElement {
	@ObjectHolder("variaty_additions:small_backpack")
	public static final Item block = null;
	public SmallBackpackItem(VariatyAdditionsModElements instance) {
		super(instance, 50);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof SmallBackpackGUIGuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			...
			setRegistryName("small_backpack");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Small Backpack");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new SmallBackpackGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
