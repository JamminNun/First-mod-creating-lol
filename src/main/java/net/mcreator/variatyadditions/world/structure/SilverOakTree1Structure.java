...
package net.mcreator.variatyadditions.world.structure;
...
public class SilverOakTree1Structure {
	...
	private static class FeatureRegisterHandler {
		...
		public static void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("variaty_additions:silver_oak_tree_1"), configuredFeature);
		}
	}
	@SubscribeEvent
