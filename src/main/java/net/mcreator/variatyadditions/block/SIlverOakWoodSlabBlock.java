...
public class SIlverOakWoodSlabBlock extends VariatyAdditionsModElements.ModElement {
	@ObjectHolder("variaty_additions:s_ilver_oak_wood_slab")
	public static final Block block = null;
	public SIlverOakWoodSlabBlock(VariatyAdditionsModElements instance) {
		super(instance, 101);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("s_ilver_oak_wood_slab");
		}
